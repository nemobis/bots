...
def printAbebooks(isbn):
	listing = html.fromstring( t.get('http://www.abebooks.it/servlet/SearchResults?isbn=%s&sortby=2&n=200000237' % code , timeout=10).text )
